...
/-!
# BinaryCC to FSAT: the cost bound and the witness

The cost bound `buildFSAT_cost_le` of the program of `BinaryCC_to_FSAT_free_run.lean` and
the resulting program witness `binaryCCFSAT_reductionLang` for the map
