...
/-!
# Tableau reduction: copy and halt cards

The programs emitting the copy and halt card families of `S1Cards.cardBlocks`, the two
atoms they are built from, and the preamble loading the stage's constants.
-/
...
open CookLevin.Lang CookLevin.Tableau HeadLayout S1Emit
