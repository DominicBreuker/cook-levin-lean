...
- **S1 is feasible but expensive — and its target is now TRUE and decomposed
  ...
  **The prelude's `Cmd` landed 2026-07-27-c** (`Reductions/S1PreludeEmit.lean`,
  ...
  Remaining: the `stepBlocks` `Cmd`, the `stageC` assembly, then the
  cost ladder.**
