...
| `sorry`s | ~30 (Group C); the C6 bit-test gadget (`Compile.bitTestTM` + run lemmas) is now **closed** `sorry`-free; the decider bridge reduces to the one `Compile_run_physical` (C2) obligation |
