...
1. **Finish the compiler `Compile_sound` (C2 — highest completion risk).**
   ...
   c. Concretise the 10 stub `compileOp`s, each with its **linear-budget**
      residue contract. **⚠ 2026-06-01 finding (do not "copy the in-place append
      template" for these):** 9 of the 10 are **cross-register** — `tail`/`copy`/
