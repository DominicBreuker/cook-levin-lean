...
`FrontS1Comp.SAT_NPhard''` in the table above. What is left for the headline is
the *membership* half (`inNPLangFreeSplit SAT`), after which `NPcomplete'' SAT`
can be stated and the legacy front retired; see `CookLevin/HANDOFF.md`.
